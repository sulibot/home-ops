...
# Pre-built: ghcr.io/sulibot/frr-talos-extension:v1.0.18
#
...
#   extension_version = "v1.0.18"  # Should come from versions.hcl
#
...
#   frr_version = "10.2"  # Should match FRR daemon version
# }

# Expected outputs (for consumption by images/ stage):
# - extension_image: Full image reference with digest
#   Example: ghcr.io/sulibot/frr-talos-extension:v1.0.18@sha256:abc123...
