# Shared unit template: flux
# Included by each cluster's flux/terragrunt.hcl. All cluster-specific values
...
terraform {
  source = "${get_repo_root()}/terraform/infra/modules//flux_stack"
