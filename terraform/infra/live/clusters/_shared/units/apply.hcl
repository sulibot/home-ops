# Shared unit template: apply
# Included by each cluster's apply/terragrunt.hcl. All cluster-specific values
...
terraform {
  source = "${get_repo_root()}/terraform/infra/modules/talos_apply_config"
