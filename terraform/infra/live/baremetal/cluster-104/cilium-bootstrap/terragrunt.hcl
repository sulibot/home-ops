...
inputs = {
  ...
  direct_routing_device   = local.cluster_config.node.interface
  ipv4_native_routing_cidr = local.ipv4_native_routing_cidr
  ipv6_native_routing_cidr = local.ipv6_native_routing_cidr
  operator_replicas       = 1
}
