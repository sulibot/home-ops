locals {
  ...
  # These BGP/RouterOS/SDN values are also exposed to Ansible as
  # ansible/network-facts.json by the common/3-ansible-facts terragrunt
  # unit (terraform/infra/modules/ansible_facts) - see
  # ansible/pve/inventory/group_vars/all.yml. Edit here, not there.
