...
inputs = {
  ...
  dns_records = concat([
    ...
    # OpenBao leader-gated floating VIP and per-node recovery endpoints.
    { name = "openbao.sulibot.com", type = "AAAA", address = "fd00:100:0:240::67", ttl = "5m" },
    { name = "openbao.sulibot.com", type = "A", address = "10.100.240.67", ttl = "5m" },
    { name = "openbao01.sulibot.com", type = "AAAA", address = "fd00:100::68", ttl = "5m" },
    { name = "openbao01.sulibot.com", type = "A", address = "10.100.0.68", ttl = "5m" },
    { name = "openbao02.sulibot.com", type = "AAAA", address = "fd00:100::69", ttl = "5m" },
    { name = "openbao02.sulibot.com", type = "A", address = "10.100.0.69", ttl = "5m" },
    { name = "openbao03.sulibot.com", type = "AAAA", address = "fd00:100::70", ttl = "5m" },
    { name = "openbao03.sulibot.com", type = "A", address = "10.100.0.70", ttl = "5m" },
