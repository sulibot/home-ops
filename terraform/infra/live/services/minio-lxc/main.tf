...
locals {
  ...
  host_domain         = "minio01.sulibot.com"
...
output "minio_endpoints" {
  value = {
    api     = "https://s3.sulibot.com"
    console = "https://minio.sulibot.com"
  }
}
...
resource "null_resource" "minio_caddy_frontend" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "/root/.acme.sh/acme.sh --issue --dns dns_cf -d minio.sulibot.com -d s3.sulibot.com --keylength ec-256 --force",
      "/root/.acme.sh/acme.sh --install-cert -d minio.sulibot.com --ecc --fullchain-file /etc/caddy/certs/minio.sulibot.com.crt --key-file /etc/caddy/certs/minio.sulibot.com.key",
      "chown root:caddy /etc/caddy/certs/minio.sulibot.com.crt /etc/caddy/certs/minio.sulibot.com.key",
      "chmod 640 /etc/caddy/certs/minio.sulibot.com.crt /etc/caddy/certs/minio.sulibot.com.key",
      "cat > /etc/caddy/Caddyfile <<'CFG'\n{\n  admin off\n}\n\nminio.sulibot.com {\n  tls /etc/caddy/certs/minio.sulibot.com.crt /etc/caddy/certs/minio.sulibot.com.key\n  reverse_proxy 127.0.0.1:9001\n}\n\ns3.sulibot.com {\n  tls /etc/caddy/certs/minio.sulibot.com.crt /etc/caddy/certs/minio.sulibot.com.key\n  reverse_proxy 127.0.0.1:9000\n}\nCFG",
      "systemctl daemon-reload",
      "systemctl enable --now caddy",
      "systemctl restart caddy",
      "curl -fsS -o /dev/null https://s3.sulibot.com/minio/health/ready || curl -kfsS -o /dev/null https://s3.sulibot.com/minio/health/ready",
    ]
  }
}
