...
- **IPv4:** `10.0.101.64/26` (10.0.101.64 - 10.0.101.127)
- **IPv6:** `fd00:101::/120` (fd00:101::0 - fd00:101::ff)
...
spec:
  type: LoadBalancer
  loadBalancerIP: 10.0.101.80  # Reserve IP for ingress
  ports:
    - name: http
      port: 80
    - name: https
